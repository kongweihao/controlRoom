...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI77X1J52Tlbln"; // AccessKeyId

        $accessKeySecret = "ARHkp3nMANGbcORMTF7AFULR8N7JHZ"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone_number,$code,$sign_name,$template_code='SMS_129670227') {
