...
class EnterprisePay extends WxPayDataBase{
    /**
     * 设置微信分配的公众账号ID
     * @param string $value
     **/
    ...
    /**
     * 获取 商户订单号，需保持唯一性(只能是字母或者数字，不能包含有符号) 的值
     * @return 值
     **/
    ...
    /**
     * 判断 商户订单号，需保持唯一性(只能是字母或者数字，不能包含有符号)。 是否存在
     * @return true 或 false
     **/
    ...
    /**
     * 设置 校验用户姓名选项     NO_CHECK：不校验真实姓名FORCE_CHECK：强校验真实姓名
     * @param string $value
     **/
    ...
    /**
     * 获取 校验用户姓名选项     NO_CHECK：不校验真实姓名FORCE_CHECK：强校验真实姓名 的值
     * @return 值
     **/
    ...
    /**
     * 判断 校验用户姓名选项     NO_CHECK：不校验真实姓名FORCE_CHECK：强校验真实姓名 是否存在
     * @return true 或 false
     **/
    ...
    /**
     * 设置   收款用户真实姓名。如果check_name设置为FORCE_CHECK，则必填用户真实姓名
     * @param string $value
     **/
    ...
    /**
     * 获取 收款用户真实姓名。如果check_name设置为FORCE_CHECK，则必填用户真实姓名 的值
     * @return 值
     **/
    ...
    /**
     * 判断 收款用户真实姓名。如果check_name设置为FORCE_CHECK，则必填用户真实姓名 是否存在
     * @return true 或 false
     **/
